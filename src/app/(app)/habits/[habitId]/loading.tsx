...
export default async function HabitDetailLoading() {
  ...
  return (
    <main
      ...
      aria-busy="true"
      aria-label={t("loadingScreens.habit")}
    >
      <div className="flex items-center gap-3 pt-2">
        <div className="size-10 shrink-0 animate-pulse rounded-lg bg-white/10" />
        <div className="h-7 max-w-48 flex-1 animate-pulse rounded-lg bg-white/10" />
      </div>

      <div className="mx-auto mt-6 flex w-full max-w-3xl flex-col gap-6">
        <div className="flex flex-col gap-3 rounded-xl bg-white/3 p-4">
